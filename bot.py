...
txt = [[['?'], ['Я бы сказала, это очень сложный вопрос. Надо подумать!', 'Да, что ты всё вопросы, вопросы... О себе расскажи :)', 'Нескажу... И не уговаривай *нет']],
       ...
       [['Привет', 'привет'], ['Привет, как делишки?', 'Привет, ну расказывай что у тебя нового.', 'Ой, привет! Кто к нам пришёл, как я по тебе соскучилась, расказывай скорей же как дела.']],
       [['дура', 'дура'], ['я те покажу дуру, сам дурак!', 'Я не дура, я повторюха Маша', 'Заебли меня все уже, дура дура... вот обижусь и уйду']],
